package one.jkr.de.jkrsoftware.entity.locking.libraries.dynamoDb.locking.library.locking.system.adapters.out.persistence;

import lombok.NonNull;
import lombok.RequiredArgsConstructor;
import lombok.extern.slf4j.Slf4j;
import one.jkr.de.jkrsoftware.entity.locking.libraries.dynamoDb.locking.library.locking.system.application.ports.out.LockPortForDynamoDB;
...
// ToDo: need to implement a DynamoDB-Client and replace the In-Memory-Map with (configurable) DynamoDB-Tables.
@RequiredArgsConstructor
@Slf4j
public class DynamoDBLockPersistor implements LockPortForDynamoDB {
